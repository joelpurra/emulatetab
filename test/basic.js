...
/// <reference path="../src/emulatetab.joelpurra.js" />
...
(function ($)
{
	...
	(function ()
	{
		...
		{
			assertTypeTab('<input id="a" type="radio" name="somename" value="Will receive focus as a group together with the other radio button" />'
				+ '<input id="b" type="radio" name="somename" value="Will receive focus as a group together with the other radio button" />')
		});
